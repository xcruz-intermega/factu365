                    ...
                    <template v-else>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <button @click="startEdit(tpl)" class="text-indigo-600 hover:text-indigo-900" :title="$t('common.edit')">
                                ...
                                <button @click="confirmDelete(tpl)" class="text-red-600 hover:text-red-900" :title="$t('common.delete')">
