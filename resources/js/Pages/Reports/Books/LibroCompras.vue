            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">{{ $t('books.col_supplier') }}</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <template v-for="group in monthGroups()" :key="group.key">
                        ...
                        <tr class="bg-blue-50">
                            <td colspan="4" class="px-4 py-2 text-sm font-medium text-blue-800">{{ $t('books.monthly_subtotal', { month: group.label }) }}</td>
