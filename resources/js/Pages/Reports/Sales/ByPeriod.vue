...
<template>
    <Head title="Ventas por periodo" />

    <AppLayout>
        <template #header>
            <h1 class="text-lg font-semibold text-gray-900">Ventas por periodo</h1>
        </template>
        ...
        <div class="mb-6 flex flex-wrap items-end gap-4">
            ...
            <div>
                <label class="block text-xs font-medium text-gray-500">Agrupar por</label>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">Periodo</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr v-if="data.length === 0">
                        <td colspan="6" class="px-4 py-8 text-center text-sm text-gray-400">Sin datos para el periodo seleccionado.</td>
                    </tr>
                </tbody>
