...
const sections = computed<NavSection[]>(() => [
    ...
    },
    {
        ...
        items: [
            { name: trans('nav.series'), href: 'settings.series', routeMatch: 'settings.series', activeUrls: ['/settings/series', '/settings/payment-templates', '/settings/pdf-templates'], icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ],
    },
    {
        ...
        hidden: !can?.manage_settings,
        items: [
            { name: trans('nav.company'), href: 'settings.company', routeMatch: 'settings.company', activeUrls: ['/settings/company', '/settings/certificates', '/settings/users', '/settings/backups', '/settings/audit-logs'], icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z' },
        ],
    },
]);
