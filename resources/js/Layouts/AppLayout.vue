...
const sections = computed<NavSection[]>(() => [
    ...
    },
    {
        ...
        items: [
            ...
            { name: trans('nav.recurring_invoices'), href: 'recurring-invoices.index', routeMatch: 'recurring-invoices.*', activeUrls: ['/recurring-invoices'], icon: 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99' },
    ...
    },
    {
        ...
        items: [
            ...
            { name: trans('nav.import_einvoice'), href: 'documents.import', routeParams: { type: 'purchase_invoice' }, routeMatch: 'documents.import*', activeUrls: ['/import'], icon: 'M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5' },
    ...
    },
    {
        ...
        items: [
            ...
            { name: trans('nav.libro_ventas'), href: 'reports.books.ventas', routeMatch: 'reports.books.ventas', icon: 'M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25' },
            { name: trans('nav.libro_compras'), href: 'reports.books.compras', routeMatch: 'reports.books.compras', icon: 'M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25' },
            { name: trans('nav.libro_expedidas'), href: 'reports.books.expedidas', routeMatch: 'reports.books.expedidas', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z' },
            { name: trans('nav.libro_recibidas'), href: 'reports.books.recibidas', routeMatch: 'reports.books.recibidas', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z' },
            ...
            { name: trans('nav.modelo_111'), href: 'reports.fiscal.modelo-111', routeMatch: 'reports.fiscal.modelo-111', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
            { name: trans('nav.modelo_115'), href: 'reports.fiscal.modelo-115', routeMatch: 'reports.fiscal.modelo-115', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
            ...
            { name: trans('nav.modelo_347'), href: 'reports.fiscal.modelo-347', routeMatch: 'reports.fiscal.modelo-347', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
    ...
    },
    {
        ...
        items: [
            ...
            { name: trans('nav.catalog'), href: 'catalog.index', routeMatch: 'catalog.*', activeUrls: ['/catalog'], icon: 'M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 21h16.5a2.25 2.25 0 002.25-2.25V5.25a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 003.75 21z' },
    ...
    },
    {
        ...
        items: [
            ...
            { name: trans('nav.vat_rates'), href: 'settings.vat-rates', routeMatch: 'settings.vat-rates*', icon: 'M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185zM9.75 9h.008v.008H9.75V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 4.5h.008v.008h-.008V13.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z' },
        ],
    },
    {
                    ...
                    <div class="flex flex-1 flex-col gap-y-1">
                        <div v-for="(section, sIdx) in sections.filter(s => !s.hidden)" :key="sIdx">
                            ...
                            <button
                                ...
                                class="mt-3 mb-1 flex w-full items-center gap-x-1 px-2 text-sm font-semibold tracking-wide text-gray-900 hover:text-black"
                            >
                                <svg
